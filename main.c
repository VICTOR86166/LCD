...
StopDelay(5);
	...
	StopDelay(20);
		...
		DispColor(RED);DispStr("RED",100,0,BLACK,WHITE); //test 
    //StopDelay(5);
	  WaitKey();Delay(200);
		
		DispColor(GREEN);DispStr("GREEN",100,0,BLACK,WHITE); //test
    //StopDelay(5);
	  WaitKey();Delay(200);
	
		DispColor(BLUE);DispStr("BLUE",100,0,BLACK,WHITE); //test
    //StopDelay(5);
	  WaitKey();Delay(200);
